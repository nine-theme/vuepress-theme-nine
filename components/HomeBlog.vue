  ...
  div(class="home-blog" :class="nineShow?'nine-show': 'nine-hide'")
    ...
    div(class="footer")
      span
        ...
        a(target="blank" href="https://hub.alili.fun") VuePress-theme-nine
      span(v-if="$themeConfig.record")
        i(class="iconfont nine-beian")
        a {{ $themeConfig.record }}
      span
        i(class="iconfont nine-copyright")
        a
          span(v-if="$themeConfig.startYear") {{ $themeConfig.startYear }} -
          | {{ year }} &nbsp;&nbsp;
